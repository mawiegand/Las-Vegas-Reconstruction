...
namespace kfusion
{
    namespace device
    {
        ...
        void integrateSlice(TsdfVolume& volume, kfusion::tsdf_buffer* buffer, const Vec3i minBounds, const Vec3i maxBounds,
                            const int weight, const Vec3i globalShift, PtrSz<float> deviceData);
