...
Options::Options(int argc, char** argv) : m_descr("Supported options")
{
	...
	m_descr.add_options()
			...
			("sliceIntegrationWeight", value<size_t>(&m_sliceIntegrationWeight)->default_value(66)->notifier(in(0, 100, "sliceIntegrationWeight")), "Weight for values of TSDF-Slice integration in percentage")
